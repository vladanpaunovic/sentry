...
export const doDontContent = {
	do: {
		text: 'Use only the approved, unmodified logo that is provided to you.',
		img: {
			src: require('../../images/gradients.png'),
			alt: 'hello'
		}
	},
	dont: {
		text: 'Don\’t modify, distort, or add additional elements to the logo. And don’t use the Sentry S.',
		img: {
			src: require('../../images/gradients.png'),
			alt: 'hello'
		}
